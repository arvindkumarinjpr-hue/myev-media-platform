...
export const PUBLISHING_ERRORS = {
  ...
  // Module 9 Phase 9.7 — account connect/manage
  PUBLISHING_WORDPRESS_VALIDATION_FAILED: "PUBLISHING_WORDPRESS_VALIDATION_FAILED",
  PUBLISHING_ACCOUNT_ALREADY_CONNECTED: "PUBLISHING_ACCOUNT_ALREADY_CONNECTED",
  PUBLISHING_ACCOUNT_DISCONNECTED: "PUBLISHING_ACCOUNT_DISCONNECTED",

  // Module 9 Phase 9.7 — OAuth connect flow
  PUBLISHING_OAUTH_PROVIDER_NOT_CONFIGURED: "PUBLISHING_OAUTH_PROVIDER_NOT_CONFIGURED",
  PUBLISHING_OAUTH_STATE_INVALID: "PUBLISHING_OAUTH_STATE_INVALID",
  PUBLISHING_OAUTH_EXCHANGE_FAILED: "PUBLISHING_OAUTH_EXCHANGE_FAILED",
  PUBLISHING_OAUTH_ACCOUNT_INELIGIBLE: "PUBLISHING_OAUTH_ACCOUNT_INELIGIBLE",

  // Module 9 Phase 9.7 — manual reconciliation (see @myev/shared's
  // PUBLISHING_RECONCILIATION_REQUIRED / PUBLISHING_RECONCILIATION_NOT_APPLICABLE
  // domain codes, translated at this process's own HTTP boundary same as
  // every other PublishingDomainError).
} as const;
