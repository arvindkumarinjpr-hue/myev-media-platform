...
export const VIDEO_ERRORS = {
  ...
  // Module 7 Phase 7.5 — rendering + QA.
  VIDEO_RENDER_PREREQUISITES_UNMET: "VIDEO_RENDER_PREREQUISITES_UNMET",
  VIDEO_RENDER_INPUT_INVALID: "VIDEO_RENDER_INPUT_INVALID",
  VIDEO_RENDER_ALREADY_RUNNING: "VIDEO_RENDER_ALREADY_RUNNING",
  VIDEO_RENDER_NOT_CURRENT: "VIDEO_RENDER_NOT_CURRENT",
  VIDEO_QA_RENDER_REQUIRED: "VIDEO_QA_RENDER_REQUIRED",
  VIDEO_QA_STALE: "VIDEO_QA_STALE",
} as const;
