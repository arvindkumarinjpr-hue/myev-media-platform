...
- **Approval Status:** Proposed — pending ACR-014 Technical Reviewer and Architecture Owner sign-off (`ACR_014_KNOWLEDGE_PACK_LINEAGE_AND_CONCURRENCY_V1.0.md`); not yet Approved per the ACR Workflow's Review → Approve/Reject stage.
- **Date:** 2026-08-22
